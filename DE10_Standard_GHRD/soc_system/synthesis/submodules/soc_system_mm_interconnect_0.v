...
module soc_system_mm_interconnect_0 (
		...
		output wire [2:0]  uart_xym_s1_address,                                                 //                                                   uart_xym_s1.address
		output wire        uart_xym_s1_write,                                                   //                                                              .write
		output wire        uart_xym_s1_read,                                                    //                                                              .read
		input  wire [15:0] uart_xym_s1_readdata,                                                //                                                              .readdata
		output wire [15:0] uart_xym_s1_writedata,                                               //                                                              .writedata
		output wire        uart_xym_s1_begintransfer,                                           //                                                              .begintransfer
		output wire        uart_xym_s1_chipselect                                               //                                                              .chipselect
	);
	...
	wire   [31:0] uart_xym_s1_agent_m0_readdata;                            // uart_xym_s1_translator:uav_readdata -> uart_xym_s1_agent:m0_readdata
	wire          uart_xym_s1_agent_m0_waitrequest;                         // uart_xym_s1_translator:uav_waitrequest -> uart_xym_s1_agent:m0_waitrequest
	wire          uart_xym_s1_agent_m0_debugaccess;                         // uart_xym_s1_agent:m0_debugaccess -> uart_xym_s1_translator:uav_debugaccess
	wire   [20:0] uart_xym_s1_agent_m0_address;                             // uart_xym_s1_agent:m0_address -> uart_xym_s1_translator:uav_address
	wire    [3:0] uart_xym_s1_agent_m0_byteenable;                          // uart_xym_s1_agent:m0_byteenable -> uart_xym_s1_translator:uav_byteenable
	wire          uart_xym_s1_agent_m0_read;                                // uart_xym_s1_agent:m0_read -> uart_xym_s1_translator:uav_read
	wire          uart_xym_s1_agent_m0_readdatavalid;                       // uart_xym_s1_translator:uav_readdatavalid -> uart_xym_s1_agent:m0_readdatavalid
	wire          uart_xym_s1_agent_m0_lock;                                // uart_xym_s1_agent:m0_lock -> uart_xym_s1_translator:uav_lock
	wire   [31:0] uart_xym_s1_agent_m0_writedata;                           // uart_xym_s1_agent:m0_writedata -> uart_xym_s1_translator:uav_writedata
	wire          uart_xym_s1_agent_m0_write;                               // uart_xym_s1_agent:m0_write -> uart_xym_s1_translator:uav_write
	wire    [2:0] uart_xym_s1_agent_m0_burstcount;                          // uart_xym_s1_agent:m0_burstcount -> uart_xym_s1_translator:uav_burstcount
	wire          uart_xym_s1_agent_rf_source_valid;                        // uart_xym_s1_agent:rf_source_valid -> uart_xym_s1_agent_rsp_fifo:in_valid
	wire  [112:0] uart_xym_s1_agent_rf_source_data;                         // uart_xym_s1_agent:rf_source_data -> uart_xym_s1_agent_rsp_fifo:in_data
	wire          uart_xym_s1_agent_rf_source_ready;                        // uart_xym_s1_agent_rsp_fifo:in_ready -> uart_xym_s1_agent:rf_source_ready
	wire          uart_xym_s1_agent_rf_source_startofpacket;                // uart_xym_s1_agent:rf_source_startofpacket -> uart_xym_s1_agent_rsp_fifo:in_startofpacket
	wire          uart_xym_s1_agent_rf_source_endofpacket;                  // uart_xym_s1_agent:rf_source_endofpacket -> uart_xym_s1_agent_rsp_fifo:in_endofpacket
	wire          uart_xym_s1_agent_rsp_fifo_out_valid;                     // uart_xym_s1_agent_rsp_fifo:out_valid -> uart_xym_s1_agent:rf_sink_valid
	wire  [112:0] uart_xym_s1_agent_rsp_fifo_out_data;                      // uart_xym_s1_agent_rsp_fifo:out_data -> uart_xym_s1_agent:rf_sink_data
	wire          uart_xym_s1_agent_rsp_fifo_out_ready;                     // uart_xym_s1_agent:rf_sink_ready -> uart_xym_s1_agent_rsp_fifo:out_ready
	wire          uart_xym_s1_agent_rsp_fifo_out_startofpacket;             // uart_xym_s1_agent_rsp_fifo:out_startofpacket -> uart_xym_s1_agent:rf_sink_startofpacket
	wire          uart_xym_s1_agent_rsp_fifo_out_endofpacket;               // uart_xym_s1_agent_rsp_fifo:out_endofpacket -> uart_xym_s1_agent:rf_sink_endofpacket
	wire          uart_xym_s1_agent_rdata_fifo_src_valid;                   // uart_xym_s1_agent:rdata_fifo_src_valid -> uart_xym_s1_agent_rdata_fifo:in_valid
	wire   [33:0] uart_xym_s1_agent_rdata_fifo_src_data;                    // uart_xym_s1_agent:rdata_fifo_src_data -> uart_xym_s1_agent_rdata_fifo:in_data
	wire          uart_xym_s1_agent_rdata_fifo_src_ready;                   // uart_xym_s1_agent_rdata_fifo:in_ready -> uart_xym_s1_agent:rdata_fifo_src_ready
	...
	wire          uart_xym_s1_agent_rp_valid;                               // uart_xym_s1_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] uart_xym_s1_agent_rp_data;                                // uart_xym_s1_agent:rp_data -> router_003:sink_data
	wire          uart_xym_s1_agent_rp_ready;                               // router_003:sink_ready -> uart_xym_s1_agent:rp_ready
	wire          uart_xym_s1_agent_rp_startofpacket;                       // uart_xym_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          uart_xym_s1_agent_rp_endofpacket;                         // uart_xym_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          cmd_mux_001_src_valid;                                    // cmd_mux_001:src_valid -> uart_xym_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> uart_xym_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // uart_xym_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> uart_xym_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                            // cmd_mux_001:src_startofpacket -> uart_xym_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                              // cmd_mux_001:src_endofpacket -> uart_xym_s1_burst_adapter:sink0_endofpacket
	wire          uart_xym_s1_burst_adapter_source0_valid;                  // uart_xym_s1_burst_adapter:source0_valid -> uart_xym_s1_agent:cp_valid
	wire  [111:0] uart_xym_s1_burst_adapter_source0_data;                   // uart_xym_s1_burst_adapter:source0_data -> uart_xym_s1_agent:cp_data
	wire          uart_xym_s1_burst_adapter_source0_ready;                  // uart_xym_s1_agent:cp_ready -> uart_xym_s1_burst_adapter:source0_ready
	wire    [1:0] uart_xym_s1_burst_adapter_source0_channel;                // uart_xym_s1_burst_adapter:source0_channel -> uart_xym_s1_agent:cp_channel
	wire          uart_xym_s1_burst_adapter_source0_startofpacket;          // uart_xym_s1_burst_adapter:source0_startofpacket -> uart_xym_s1_agent:cp_startofpacket
	wire          uart_xym_s1_burst_adapter_source0_endofpacket;            // uart_xym_s1_burst_adapter:source0_endofpacket -> uart_xym_s1_agent:cp_endofpacket
	...
	wire          uart_xym_s1_agent_rdata_fifo_out_valid;                   // uart_xym_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] uart_xym_s1_agent_rdata_fifo_out_data;                    // uart_xym_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          uart_xym_s1_agent_rdata_fifo_out_ready;                   // avalon_st_adapter_001:in_0_ready -> uart_xym_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                        // avalon_st_adapter_001:out_0_valid -> uart_xym_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                         // avalon_st_adapter_001:out_0_data -> uart_xym_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                        // uart_xym_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                        // avalon_st_adapter_001:out_0_error -> uart_xym_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) uart_xym_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (mm_bridge_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (uart_xym_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (uart_xym_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (uart_xym_s1_agent_m0_read),                     //                         .read
		.uav_write              (uart_xym_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (uart_xym_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (uart_xym_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (uart_xym_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (uart_xym_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (uart_xym_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (uart_xym_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (uart_xym_s1_agent_m0_debugaccess),              //                         .debugaccess
		.av_address             (uart_xym_s1_address),                           //      avalon_anti_slave_0.address
		.av_write               (uart_xym_s1_write),                             //                         .write
		.av_read                (uart_xym_s1_read),                              //                         .read
		.av_readdata            (uart_xym_s1_readdata),                          //                         .readdata
		.av_writedata           (uart_xym_s1_writedata),                         //                         .writedata
		.av_begintransfer       (uart_xym_s1_begintransfer),                     //                         .begintransfer
		.av_chipselect          (uart_xym_s1_chipselect),                        //                         .chipselect
		.av_beginbursttransfer  (),                                              //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (mm_bridge_0_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (uart_xym_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (uart_xym_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (uart_xym_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (uart_xym_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (uart_xym_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (uart_xym_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (uart_xym_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (uart_xym_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (uart_xym_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (uart_xym_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (uart_xym_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (uart_xym_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (uart_xym_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (uart_xym_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (uart_xym_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (uart_xym_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (uart_xym_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (uart_xym_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (uart_xym_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (uart_xym_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (uart_xym_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (uart_xym_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (uart_xym_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (uart_xym_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (uart_xym_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (uart_xym_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (uart_xym_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (uart_xym_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (uart_xym_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (uart_xym_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (uart_xym_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (uart_xym_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),               //                .error
		.rdata_fifo_src_ready    (uart_xym_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (uart_xym_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (uart_xym_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) uart_xym_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (uart_xym_s1_agent_rf_source_data),              //        in.data
		.in_valid          (uart_xym_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (uart_xym_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (uart_xym_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (uart_xym_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (uart_xym_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (uart_xym_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (uart_xym_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (uart_xym_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (uart_xym_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) uart_xym_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (uart_xym_s1_agent_rdata_fifo_src_data),         //        in.data
		.in_valid          (uart_xym_s1_agent_rdata_fifo_src_valid),        //          .valid
		.in_ready          (uart_xym_s1_agent_rdata_fifo_src_ready),        //          .ready
		.out_data          (uart_xym_s1_agent_rdata_fifo_out_data),         //       out.data
		.out_valid         (uart_xym_s1_agent_rdata_fifo_out_valid),        //          .valid
		.out_ready         (uart_xym_s1_agent_rdata_fifo_out_ready),        //          .ready
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	soc_system_mm_interconnect_0_router_002 router_003 (
		.sink_ready         (uart_xym_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (uart_xym_s1_agent_rp_valid),                    //          .valid
		.sink_data          (uart_xym_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (uart_xym_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (uart_xym_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (mm_bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (uart_xym_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (uart_xym_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (uart_xym_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (uart_xym_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (uart_xym_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (uart_xym_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (mm_bridge_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (uart_xym_s1_agent_rdata_fifo_out_data),         //     in_0.data
		.in_0_valid     (uart_xym_s1_agent_rdata_fifo_out_valid),        //         .valid
		.in_0_ready     (uart_xym_s1_agent_rdata_fifo_out_ready),        //         .ready
